declare module 'elasticsearch' {
    export class Client {
        ...
        bulk(params: BulkRequest): Promise<BulkResponse>;
    ...
    export interface BulkType {
        index?: BulkActionDetails;
        update?: BulkActionDetails;
        delete?: BulkActionDetails;
    }

    export interface BulkActionDetails {
        _index?: string;
        _type?: string;
        _id?: string;
    }
    ...
    export interface BulkRequest extends BulkOptions {
        body: Array<any>
    }

    export interface BulkAction {
        details: BulkActionDetails
        toArray(): Array<BulkType | any>;
    }
